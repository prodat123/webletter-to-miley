            ...
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:flex">
                <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
                    ...
                    <p className="max-w-xl mx-auto xl:mx-0">
                        One of the core components of the IB curriculum! If you do not get an A or B for this subject, you will not be able to score full marks.
                    </p>
                    <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0 xl:justify-start">
                        <a href="#objects" className="flex items-center justify-center gap-x-2 py-2 px-4 text-white font-medium bg-primary duration-150 hover:bg-gray-700 active:bg-gray-900 rounded-lg md:inline-flex">
                            View Objects
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                ...
                <div className="flex-1 max-w-xl mx-auto mt-14 xl:mt-0">
                    <div className="relative">
                        ...
                        {/* <button className="absolute w-16 h-16 rounded-full inset-0 m-auto duration-150 bg-secondary hover:bg-blue-600 ring-offset-2 focus:ring text-white"
