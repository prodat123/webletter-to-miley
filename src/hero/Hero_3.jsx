  ...
  return (
    ...
    <section className="py-14 max-w-screen-xl mx-auto">
        <div className="relative overflow-hidden mx-4 px-4 py-14 rounded-2xl bg-primary md:px-8 md:mx-8">
            <div className="relative z-10 max-w-xl mx-auto sm:text-center">
                ...
                <div className="mt-6">
                    <form
                        ...
                        />
                        <button
                            className="p-2 px-3 rounded-lg font-medium text-white bg-secondary duration-150 outline-none shadow-md focus:shadow-none sm:px-4"
                        >
                            Subscribe
                        </button>
                    </form>
            ...
            <div className="absolute inset-0 w-full h-full bg-gradient-to-tl from-secodary via-primary to-secondary" ></div>
        </div>
    </section>
