        ...
        <div>
            <main className="flex overflow-hidden">
                <div className="flex-1 hidden lg:block">
                    <img src={require("../images/placeholder.jpg")} className="w-full h-screen object-cover" />
                </div>
                                        ...
                                        servicesItems.map((item, idx) => (
                                            <li key={idx} className="flex gap-x-3 text-sm">
                                                <div>
                                                    ...
                                                    <label
                                                        htmlFor={`service-${idx}`}
                                                        className="relative flex w-5 h-5 bg-white peer-checked:bg-primary rounded-md border ring-offset-2 ring-indigo-600 duration-150 peer-active:ring cursor-pointer after:absolute after:inset-x-0 after:top-[3px] after:m-auto after:w-1.5 after:h-2.5 after:border-r-2 after:border-b-2 after:border-white after:rotate-45"
                                                    >
                                                    </label>
                                                </div>
